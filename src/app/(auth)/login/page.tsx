  ...
  return (
    <div className="rounded-2xl border border-vma-border bg-vma-surface p-8 shadow-2xl">
      ...
      <Button
        type="button"
        variant="outline"
        className="w-full mb-6 border-vma-border-bright bg-transparent text-vma-text hover:bg-vma-surface-2"
      ...
      <div className="relative mb-6">
        <div className="absolute inset-0 flex items-center">
          <span className="w-full border-t border-vma-border" />
        </div>
        <div className="relative flex justify-center text-xs">
          <span className="bg-vma-surface px-3 text-vma-text-muted">or</span>
        </div>
      </div>
